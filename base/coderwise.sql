...
-- datos de prueba 
INSERT INTO Usuarios (Nombre, Apellido, Edad, Email, Contraseña) VALUES ('Juan', 'Pérez', 30, 'juan@example.com', 'contraseña123'),('María', 'Gómez', 25, 'maria@example.com', 'clave456'),('Ana', 'López', 28, 'ana@example.com', 'contraseña_emp'),('Luis', 'Martínez', 35, 'luis@example.com', 'clave_emp');
INSERT INTO Clientes (CI, IDUsuario, Tel, Email, Contraseña) VALUES (1234567, (SELECT IDUsuario FROM Usuarios WHERE Nombre = 'Juan'), '555-1234', 'juan@example.com', 'contraseña123'),(9876543, (SELECT IDUsuario FROM Usuarios WHERE Nombre = 'María'), '555-5678', 'maria@example.com', 'clave456');
INSERT INTO Empleados (IDUsuario, Nombre, Apellido, Edad, Email, Contraseña, FechaIng) VALUES ((SELECT IDUsuario FROM Usuarios WHERE Nombre = 'Ana'), 'Ana', 'López', 28, 'ana@example.com', 'contraseña_emp', '2023-10-16'),((SELECT IDUsuario FROM Usuarios WHERE Nombre = 'Luis'), 'Luis', 'Martínez', 35, 'luis@example.com', 'clave_emp', '2023-10-16');
INSERT INTO Administradores (CedEmp, IDUsuario, Nombre, Apellido, Email, Contraseña, FechaIng) VALUES ((SELECT CedEmp FROM Empleados WHERE Nombre = 'Ana'), (SELECT IDUsuario FROM Usuarios WHERE Nombre = 'Ana'), 'Ana', 'López', 'ana@example.com', 'contraseña_emp', '2023-10-16');
...
INSERT INTO Lineas (IdServicio, IDruta, DuracionViaje, Precio) VALUES (1, 1, '01:30:00', 171),(2, 2, '02:15:00', 300);
